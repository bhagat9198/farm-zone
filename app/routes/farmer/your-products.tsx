            ...
            <div className="flex " >
              ...
              <div className="mx-24 w-full flex flex-col justify-between" >
                <div className="p-4">
                  ...
                  <div className="flex flex-col items-baseline mb-1 space-x-2">
                    <p className=" text-primary font-semibold">{_p.description}</p>
                    <p className=" text-gray-400">Created At : {new Date(_p.created_at).toLocaleDateString()}</p>
                  </div>
                  <div className="flex items-baseline mb-1 space-x-2">
...
export const action = async (actionData) => {
  console.log('actionData :: ', actionData.request.method);
